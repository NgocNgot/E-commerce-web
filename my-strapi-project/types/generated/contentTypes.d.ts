...
export interface ApiAmountOffOrderAmountOffOrder
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::amount-off-order.amount-off-order'
    > &
      Schema.Attribute.Private;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    recurringDays: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
    recurringType: Schema.Attribute.Enumeration<['weekly', 'monthly']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiAmountOffProductAmountOffProduct
  extends Struct.CollectionTypeSchema {
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amount_off_products: Schema.Attribute.Relation<
      'manyToMany',
      'api::amount-off-product.amount-off-product'
    >;
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amount_off_order: Schema.Attribute.Relation<
      'oneToMany',
      'api::amount-off-order.amount-off-order'
    >;
    amount_off_products: Schema.Attribute.Relation<
    ...
    excludedUsers: Schema.Attribute.Relation<
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    maximumUses: Schema.Attribute.Integer;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::amount-off-order.amount-off-order': ApiAmountOffOrderAmountOffOrder;
      'api::amount-off-product.amount-off-product': ApiAmountOffProductAmountOffProduct;
